...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Nov 2015 08:02:08 GMT -->
<head>
                            ...
                            <ul class="top-user-area-list list list-horizontal list-border">
                                ...
                                <li class="nav-drop"><a href="#">USD $<i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i></a>
                                    <ul class="list nav-drop-menu">
                                        <li><a href="#">EUR<span class="right">ˆ</span></a>
                                        </li>
                                        <li><a href="#">GBP<span class="right">?</span></a>
                                        </li>
                                        <li><a href="#">JPY<span class="right">?</span></a>
                                        </li>
                ...
                <ul class="slimmenu" id="slimmenu">
                    <li class="active"><a href="index-2.html">Home</a>
                        <ul>
                            ...
                            <li class="active"><a href="index-1.html">Layout 1</a>
                            </li>
                        ...
                        <div class="col-md-5 col-md-offset-7">
                            ...
                            <div class="testimonial text-white mt50 hidden-sm hidden-xs">
                                <div class="testimonial-inner">
                                    <blockquote>
                                        <p>Aliquet eget per venenatis dis non mus ut rhoncus ullamcorper posuere malesuada sociosqu habitasse vitae</p>
                                    </blockquote>
                                </div>
                                <div class="testimonial-author">
                                    <img src="img/gamer_chick_50x50.jpg" alt="Image Alternative text" title="Gamer Chick" />
                                    <p class="testimonial-author-name">Oliver Ross</p><cite>on <a class="text-udl" href="#">The Benjamin</a> hotel in New York</cite>
                                </div>
                            </div>
                            <!-- END TESTIMONIAL -->
                        </div>
